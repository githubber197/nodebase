...
/**
 * Hook to remove a credential by its ID. It uses the TRPC client to call the remove mutation and handles success and error cases with toast notifications. On success, it invalidates the credentials query to refresh the list.
